				...
				>
					...
					<div className="relative z-10">
						...
						<div className="font-mono">
							...
							<motion.a
								href="mailto:vaibhav.gupta3659@gmail.com"
							...
							>
								vaibhav.gupta3659@gmail.com
							</motion.a>
							<p className="text-green-500 mt-8 mb-2">$ cat resume.pdf</p>
							<motion.a
								href="https://drive.google.com/file/d/1ITyUuZdYWGv4o0Q8Ok7VDI7thXwBF94-/view?usp=drive_link"
								target="_blank"
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
								<motion.a
									href="https://github.com/vaibhavgupta04"
								...
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">@vaibhavgupta04</p>
									</div>
								</motion.a>
								<motion.a
									href="https://www.linkedin.com/in/vaibhav-04/"
									whileHover={{ scale: 1.05 }}
									className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
								>
									<div className="p-2 bg-gray-700/50 rounded-lg group-hover:bg-gray-600/50 transition-colors">
									...
									<div>
										...
										<p className="text-sm text-gray-400">@vaibhav-04</p>
									</div>
								</motion.a>
								<motion.a
									href="https://www.instagram.com/vaibhav.gupta3659/"
									whileHover={{ scale: 1.05 }}
									className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
								>
									<div className="p-2 bg-gray-700/50 rounded-lg group-hover:bg-gray-600/50 transition-colors">
									...
									<div>
										...
										<p className="text-sm text-gray-400">@vaibhav.gupta3659</p>
									</div>
								</motion.a>
							</div>
						</div>
